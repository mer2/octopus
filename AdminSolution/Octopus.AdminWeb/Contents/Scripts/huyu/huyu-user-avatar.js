define("staticHuyu/huyu-user-avatar", function (require, exports, module) {
	...
	$(function () {
				...
				switch (status) {
					case '1':
						layer.showMsg("上传成功", function () {
							window.location.href = settings.urls.profileUrl;
						}, "success");
						break;
					case '2':
						break;
		...
		//swfobject.embedSWF("/contents/FaustCplus.swf",
		swfobject.embedSWF(settings.urls.resourceUrl + "/libs/faustcplus2/FaustCplus.swf",
			...
			"900", "500", "9.0.0", "expressInstall.swf", {
				...
				"uploadUrl": "/HuyuUser/UploadAvatar",//文件上传地址
				"pSize": "300|300|276|276|200|200|60|60",//头像格式（括号里的为可选）：选择框宽|选择框高|大头像宽|大头像高（|中头像宽|中头像高|小头像宽|小头像高）
