define("staticHuyu/huyu-user-bindemail", function (require, exports, module) {
	...
	security.clientOptions.views["ValidateCaptcha"] = {
		...
		validationHtml: '<tr><td class="title"><i>*</i><label for="{0}_securityValue">验证码：</label></td><td class="captcha"><input id="{0}_securityValue" name="securityValue" type="text" autocomplete="false" maxlength="4" placeholder="请点击输入验证码" /><span id="{0}_captcha_focus"></span><p></p></td></tr>',
	...
	security.showBroker({
		loaded: function(result, options) {
			$("#theForm").validate($.extend(true, {
				...
				messages: {
					oldEmail: {
						defaultMessage: "请补全当前登记的邮箱地址",
						required: "请补全当前登记的邮箱地址",
						email: "请输入正确格式的邮箱"
					},
					email: {
